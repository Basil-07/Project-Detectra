...
compound_files = {name: DATA_DIR / f"{name}.csv" for name in ALL_COMPOUNDS}
...
def train_multi_models():
    ...
    joblib.dump(trained_chains, MODELS_DIR / "ensemble_classifier_chains.pkl")
    joblib.dump(mlb, MODELS_DIR / "multidrug_label_binarizer.pkl")
