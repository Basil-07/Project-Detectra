...
def train_models(features_df):
    ...
    # Save models
    joblib.dump(binary_pipeline, MODELS_DIR / "drug_binary_xgb.pkl")
    joblib.dump(multiclass_pipeline, MODELS_DIR / "drug_multiclass_xgb.pkl")
    joblib.dump(le, MODELS_DIR / "drug_label_encoder.pkl")
...
def train_and_save_models():
    # Define input files
    drug_files = {
        "cocaine": DATA_DIR / "cocaine.csv",
        "heroin": DATA_DIR / "heroin.csv",
        "methadone": DATA_DIR / "methadone.csv",
        "morphine": DATA_DIR / "morphine.csv",
        "meth": DATA_DIR / "meth.csv",
    }
    non_drug_files = [
        DATA_DIR / "lactic.csv",
        DATA_DIR / "citric.csv",
        DATA_DIR / "ethanol.csv",
        DATA_DIR / "glucose.csv",
        DATA_DIR / "sucrose.csv",
    ]
