...
from detectra.paths import DATA_DIR, MODELS_DIR, PROJECT_ROOT
...
mlb = joblib.load(MODELS_DIR / "multidrug_label_binarizer.pkl")
...
output_file = PROJECT_ROOT / "instance" / "multi_model_evaluation.csv"
